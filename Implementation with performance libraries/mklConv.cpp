...
float * convolution_withoutpadding_mkl(float *matrix, int dimOfMatrix, float *kernel, int kernelSize) {
    ...
    float *convolution = (float *)malloc((dimOfMatrix - kernelSize + 1)*(dimOfMatrix - kernelSize + 1) * sizeof(float));
...
float * convolution_withpadding_mkl(float *matrix, int dimOfMatrix, float *kernel, int kernelSize) {
    ...
    float *convolution = (float *)malloc((dimOfMatrix)*(dimOfMatrix) * sizeof(float));
    if (kernelSize > 0 && dimOfMatrix >= kernelSize) {
